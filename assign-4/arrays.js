...
// e.g. 
var AsiaCountries = ['Pakistan', 'India', 'China', 'Afganistan', 'Bangladesh'];
...
var multipleDataTypes = [786, true, {}, [], 'Abdul Moiz Lakhani', undefined, null];
console.log(multipleDataTypes[4] + ' is so work hard man');
//we also pull array in array known as 'nested array' [[]]
var nestedArray = ['Sir Kamran Khan Tessori', ['Work hard', 'Honourable']];
